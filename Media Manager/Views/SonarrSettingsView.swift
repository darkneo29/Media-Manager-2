...
struct SonarrSettingsView: View {
    ...
    private var iOSContent: some View {
        ScrollView {
            VStack(spacing: AppSpacing.lg) {
                ...
                SettingsSection(title: "Connection", footer: "Enter the full URL to your Sonarr instance and your API key.") {
                    VStack(alignment: .leading, spacing: 0) {
                        HStack {
                            ...
                            TextField("https://sonarr.example.com", text: $editingURL)
                                .font(AppTypography.body())
                        ...
                        APIKeyHelpButton(service: .sonarr)
                            .padding()
                    }
                }
    ...
    private func loadSettings() {
        editingURL = configuration.sonarrURL
        editingAPIKey = configuration.sonarrAPIKey
    }
